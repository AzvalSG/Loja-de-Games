...
public class CategoriaController {
    ...
    @GetMapping("/descricaocat/{descricaocat}")
    public ResponseEntity<List<Categoria>> getByDescricaocat(@PathVariable 
    String descricaocat){
        return ResponseEntity.ok(categoriaRepository
            .findAllByDescricaocatContainingIgnoreCase(descricaocat));
    }
